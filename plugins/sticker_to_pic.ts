  ...
  private async handleStickerToPic(msg: Api.Message): Promise<void> {
    ...
    try {
      ...
      if (sub === "check") {
        ...
        try {
          ...
          try {
            ...
            await msg.edit({
              text: `✅ <b>ImageMagick状态正常</b><br><br><b>版本信息:</b><br><code>${htmlEscape(versionLine)}</code><br><br>🎯 <b>功能状态:</b> 可正常使用贴纸转换功能`,
              parseMode: "html"
            });
          } catch (error) {
            await msg.edit({
              text: "✅ <b>ImageMagick已安装</b><br><br>⚠️ 无法获取版本信息，但可正常使用",
              parseMode: "html"
            });
          }
        } catch (error) {
          // 未安装，尝试自动安装
          await msg.edit({ text: "❌ <b>ImageMagick未安装</b><br><br>🔄 正在自动安装，请稍候...", parseMode: "html" });
          ...
          if (isInstalled) {
            try {
              ...
              const versionLine = version.split('\n')[0];
              await msg.edit({
                text: `🎉 <b>ImageMagick自动安装成功！</b><br><br><b>版本信息:</b><br><code>${htmlEscape(versionLine)}</code><br><br>✅ <b>状态:</b> 现在可以正常使用贴纸转换功能`,
                parseMode: "html"
              });
            } catch (versionError) {
              await msg.edit({
                text: "🎉 <b>ImageMagick自动安装成功！</b><br><br>✅ <b>状态:</b> 现在可以正常使用贴纸转换功能",
                parseMode: "html"
              });
            }
          } else {
            ...
            await msg.edit({
              text: `❌ <b>ImageMagick自动安装失败</b><br><br><b>检测到系统:</b> ${platformName}<br><b>手动安装命令:</b><br><code>${htmlEscape(installCmd)}</code>`,
              parseMode: "html"
            });
          }
        }
      ...
      if (sub === 'png') {
        ...
        // 未知子命令，提示错误
        await msg.edit({
          text: `❌ <b>未知子命令:</b> <code>${htmlEscape(sub)}</code><br><br>请使用 <code>${mainPrefix}stp help</code> 查看可用选项`,
          parseMode: "html"
        });
        return;
      }
  ...
  private async processStickerConversion(
    ...
    try {
      ...
      try {
        ...
        if (!isImageMagickReady) {
          ...
          if (!retryInstall) {
            ...
            await msg.edit({
              text: `❌ <b>ImageMagick自动安装失败</b><br><br><b>请手动安装:</b><br><code>${htmlEscape(installCmd)}</code>`,
              parseMode: "html"
            });
            return;
          }
        ...
        try {
          ...
          await msg.edit({
            text: `❌ <b>贴纸转换失败</b><br><br><b>错误详情:</b> ${htmlEscape(convertError.message)}<br><br>💡 请确保贴纸格式正确`,
            parseMode: "html"
          });
          return;
        }
      ...
      if (error.message.includes('MEDIA_INVALID')) {
        ...
        errorMsg += `<br><br><b>错误详情:</b> ${htmlEscape(error.message)}`;
      }
